...
while (true) {
  ...
  if (strres > str_max - 30 or l1 < l1_cal+5 or l2 < l2_cal+5) {
    if (abs(err_com) > 60) {
      orbit()
      exit2:
    } else {
      //slow padik
        while (strres < str_max - 30 and l1 < l1_cal and l2 < l2_cal and abs(dir1 - 5) < 2) {
          if (strres > str_max - 40) {
            v=(120-0.7*strres)
  ...
  while (l1 > l1_cal + 5 and l2 > l2_cal + 5) {
    if (v < 101) {
      v = v + 0.05
    }
